...
import com.matjuillard.user.ident.server.model.request.PasswordResetModel;
import com.matjuillard.user.ident.server.model.request.PasswordResetRequestModel;
import com.matjuillard.user.ident.server.model.request.UserDetailsRequestModel;
import com.matjuillard.user.ident.server.model.response.AddressRest;
import com.matjuillard.user.ident.server.model.response.OperationStatusModel;
import com.matjuillard.user.ident.server.model.response.RequestOperationName;
import com.matjuillard.user.ident.server.model.response.RequestOperationStatus;
